...
namespace MovieAnalytics.API.Migrations
{
    ...
    [Migration("20250203015444_AddMovieLikeEntity")]
    partial class AddMovieLikeEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MovieAnalytics.API.Entities.MovieLike", b =>
                {
                    ...
                    b.Property<string>("LikedMovieId")
                        .HasColumnType("TEXT");

                    b.HasKey("SourceUserId", "LikedMovieId");

                    b.HasIndex("LikedMovieId");
